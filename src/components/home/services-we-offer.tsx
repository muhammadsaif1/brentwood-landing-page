        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group"
            >
              <Card className="bg-white border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden relative">
                <CardContent className="p-8 text-center relative">
                  ...
                  <motion.div
                    ...
                    className="absolute inset-0 bg-gradient-to-br from-orange-500/90 to-red-600/90 flex items-center justify-center z-10"
                  >
                    <Link href="/contact">
                      <Button className="bg-white text-orange-600 hover:bg-gray-100 font-semibold px-6 py-2 rounded-full transform hover:scale-105 transition-all duration-300">
                        Get a Quote
                      </Button>
                    </Link>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.3 }}
                    className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gray-100 flex items-center justify-center group-hover:bg-white/20 transition-all duration-300`}
                  >
                    <service.icon
