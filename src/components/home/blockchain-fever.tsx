    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          className="absolute top-20 left-20 w-32 h-32 bg-orange-400/10 rounded-full blur-xl"
        />
        <motion.div
          animate={{
            x: [0, -80, 0],
          ...
          className="absolute bottom-20 right-20 w-48 h-48 bg-red-400/10 rounded-full blur-xl"
        />
      </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <motion.div
                  ...
                  className="w-80 h-80 mx-auto bg-gradient-to-r from-orange-500/20 to-red-600/20 rounded-full flex items-center justify-center"
                >
                  <div className="w-60 h-60 bg-gradient-to-r from-orange-500/30 to-red-600/30 rounded-full flex items-center justify-center">
