              ...
              <div className="relative z-10 p-8 h-80 flex flex-col justify-end">
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-gradient-to-r from-orange-500 to-red-600 text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg transition-all duration-300 self-start"
                  >
                    Learn More
                  </motion.button>
                </motion.div>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                  className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-orange-500 to-red-600"
                />
              </div>
            </motion.div>
          ))}
